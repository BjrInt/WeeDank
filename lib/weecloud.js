...
exports.connect = function(socket, data, cb) {
  ...
  socket.on('message', function(bufferid, message) {
    client.send('input ' + bufferid + ' ' + message.replaceMojis(emojisDic))
  })
